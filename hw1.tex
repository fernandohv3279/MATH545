...
\item Strauss section 1.2
	\begin{enumerate}
		...
		Hence, \[au_x+bu_y+cu=a\left(au_{x'}+bu_{y'} \right)+b\left(bu_{x'}-au_{y'}\right)=\left(a^2+b^2\right)u_{x'}+cu=0.\]
		...
		So \[au_x+bu_y+cu= a\cdot b f'(bx-ay)e^{-\frac{c}{a^2+b^2}(ax+by)} -\frac{ac}{a^2+b^2} \cdot e^{-\frac{c}{a^2+b^2}(ax+by)}f(bx-ay)-b a f'(bx-ay)e^{-\frac{c}{a^2+b^2}(ax+by)} -\frac{bc}{a^2+b^2} \cdot e^{-\frac{c}{a^2+b^2}(ax+by)}f(bx-ay)\]
	\end{enumerate}
