...
\item Strauss section 1.4
	\begin{enumerate}
	   ...
	   Therefore, the diffusion of gas along a tube that is closed off at the end $x=0$ satisfies the boundary condition $ \frac{\partial u}{\partial x}(0,t)=0.$
		\item Exercise 2.c  Show that the three-dimensional version of (a) (insulated solid) or (b) (impermeable container) leads to the boundart condition $\partial u/ \partial n=0$.
