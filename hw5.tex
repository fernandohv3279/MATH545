...
\begin{align*}
    ...
    \int_{\mathbb{R}^3}v\Delta\phi &=\lim_{\varepsilon\to0}\left[
    \frac{1}{4\pi} \int_{\partial B_1} \phi(\varepsilon x) \right]\\
    \int_{\mathbb{R}^3}v\Delta\phi &=
    \frac{1}{4\pi} \phi(0) \int_{\partial B_1}1= \phi(0),
\end{align*}
where we assumed we can take the limit inside the integral because $\phi$ is
sufficiently nice. This concludes the proof.
\section*{Section 7.3}
